...
public interface RankDao {
    ...
    @Select("select class_id,day_distance as total from class_distance_rank")
    List<RankInfo> selectClaDayRank();
    @Select("select class_id,week_distance as total from class_distance_rank")
    List<RankInfo> selectClaWeekRank();
    @Select("select class_id,month_distance as total from class_distance_rank")
