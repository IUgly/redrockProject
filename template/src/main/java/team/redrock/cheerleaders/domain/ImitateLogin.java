...
public class ImitateLogin {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(ImitateLogin("15223166166", "kk123456."));
    }


    public static String ImitateLogin(String name, String pswd) throws Exception {
        String loginUrl = "https://cas.gaoxiaobang.com/login?tenant_id=309&service=https%3A%2F%2Fcqupt.gaoxiaobang.com%2F";
        String dataUrl = "https://cas.gaoxiaobang.com/login?tenant_id=309&service=https%3A%2F%2Fcqupt.gaoxiaobang.com%2F";
